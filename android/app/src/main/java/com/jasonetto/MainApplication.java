...
import com.jasonetto.seed.Modules.Jasonette.JasonettePackage;
    ...
    public void trigger(JSONObject intent_to_resolve, JasonViewActivity context) {
        try {
            ...
            if (type.equalsIgnoreCase("success")) {
                ...
                // error
                JSONObject handler = ((MainApplication) context.getApplicationContext()).getHandler(String.valueOf(intent_to_resolve.getInt("name")));
