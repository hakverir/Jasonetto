...
public class JasonModel{
    ...
    public JasonModel(String url, Intent intent, JasonViewActivity view){
        this.url = url;
        this.view = view;
        this.client = ((MainApplication)view.getApplication()).getHttpClient();
        ...
        try {
            ...
            v.put("url", this.url);
            ((MainApplication)(this.view.getApplicationContext())).setEnv("view", v);
        } catch (Exception e){
            Log.d("Warning", e.getStackTrace()[0].getMethodName() + " : " + e.toString());
        };
    }
    ...
    public void set(String name, JSONObject data){
        if(name.equalsIgnoreCase("jason")) {
            ...
            try {
                ...
                state.put("$global", ((MainApplication)(this.view.getApplicationContext())).getGlobal());
                state.put("$env", ((MainApplication)(this.view.getApplicationContext())).getEnv());
