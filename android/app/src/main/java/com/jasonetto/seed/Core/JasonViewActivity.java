package com.jasonetto.seed.Core;
...
import com.jasonetto.seed.Component.JasonComponentFactory;
import com.jasonetto.seed.Component.JasonImageComponent;
import com.jasonetto.seed.Helper.JasonHelper;
import com.jasonetto.MainApplication;
import com.jasonetto.seed.Lib.BackgroundCameraManager;
import com.jasonetto.seed.Lib.MaterialBadgeTextView;
import com.jasonetto.R;
import com.jasonetto.seed.Section.ItemAdapter;
        ...
        try {
            if(intent_to_resolve != null) {
                if(intent_to_resolve.has("type")){
                    ((MainApplication)getApplicationContext()).trigger(intent_to_resolve, JasonViewActivity.this);
